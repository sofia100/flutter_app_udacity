...
class ConverterRouteState extends State<ConverterRoute>
{
  ...
  void updateConv() {
    setState(() {
      convertedValue =
          _format(inputValue * (toValue.conversion / fromValue.conversion));
    });
  }


  void updateIpVal(String input) {
    setState(() {
  ...
  void updateToConv(dynamic unitName) {
    setState(() {
  ...
  void updateFrmConv(dynamic unitName) {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget input=  Column(
      ...
      decoration: InputDecoration(
        labelText: "Enter the input value",
        ...
        onChanged: updateIpVal,
    ),

        createDropdown(fromValue.name,updateFrmConv),
      ]
    );

    // TODO: Create a compare arrows icon.
    final Widget compareIcon=RotatedBox(
        child: Padding(
    ...
    final Widget output=  Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
        children:[ TextField(
         ...
         createDropdown(toValue.name,updateToConv),
        ]
    );
...
*/
/*   final unitwid=widget.units.map((Unit unit)
    {
      return Container(
        color: widget.color,
